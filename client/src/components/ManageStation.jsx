...
function ManageStation() {
    ...
    return (
        <div className='w-screen h-screen flex flex-col'>
            ...
            <div>
                <button type="button" class="text-white fixed mt-3 top-10 right-10 bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700 w-30 h-10" onClick={openModel}>Add Station</button>
            </div>
