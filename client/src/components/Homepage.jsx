  ...
  return (
    ...
    <div className='flex flex-col mx-[4%] gap-10'>
      ...
      <div className=' w-full mt-10'>
        <h1 className="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl"><span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Better Environment</span> Scalable Tech.</h1>
        <p className="text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">Empowering your electric journey with effortless charging solutions. Connect, charge, and drive green with ease.</p>
      </div>
      <div className='mt-10'>
        <h2 className="mb-4 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl dark:text-white">Services</h2>
      </div>
